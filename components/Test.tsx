  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const ALL_TI_YMD = `${AY}${month}${day}`;
        const API_URL = `https://open.neis.go.kr/hub/hisTimetable?KEY=${KEY}&Type=json&pIndex=1&pSize=100&ATPT_OFCDC_SC_CODE=${ATPT_OFCDC_SC_CODE}&SD_SCHUL_CODE=${SD_SCHUL_CODE}&GRADE=${GRADE}&CLASS_NM=${CLASS_NM}&AY=${AY}&ALL_TI_YMD=${ALL_TI_YMD}`;
